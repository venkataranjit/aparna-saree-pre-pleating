...
const Bookings = () => {
  ...
  const inProgressCount = useMemo(() => {
    return orders.filter(
      (o) => (o.status || o.orderStatus || 'in-progress').toLowerCase() === 'in-progress'
    ).length;
  }, [orders]);
  ...
  const orderTabs = useMemo(
    ...
    [totalOrdersCount, inProgressCount, completedCount, pendingCount, cancelledCount]
  );
  ...
  const filteredOrders = useMemo(() => {
    ...
    return orders.filter((order) => {
      const statusVal = (order.status || order.orderStatus || 'in-progress').toUpperCase();
    ...
    <div className="bookings-page">
      ...
      {loading ? (
        <div className="bookings-loading-wrapper">
          ...
          <span className="bookings-loading-text">Loading bookings & orders...</span>
        </div>
            ...
            <AppTable className="bookings-table">
              <AppTableHead>
                <AppTableRow>
                  ...
                  <AppTableCell head className="th-actions" style={{ textAlign: 'right' }}>
                    ACTIONS
                  </AppTableCell>
                </AppTableRow>
              </AppTableHead>
              <AppTableBody>
                {paginatedOrders.map((order) => {
                  ...
                  const statusVal = (order.status || order.orderStatus || 'in-progress').toLowerCase();
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Actions */}
                      <AppTableCell style={{ textAlign: 'right', whiteSpace: 'nowrap' }}>
